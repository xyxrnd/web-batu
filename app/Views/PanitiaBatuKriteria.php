    ...
    <?php foreach ($kriteria as $k): ?>
        <div class="card shadow mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?= base_url('ahp-sub/tambah/' . $batu['id_batu'] . '/' . $k['id_kriteria']) ?>"
                        class="btn btn-info btn-sm">
                        ⚖ Tambah Bobot
                    </a>

                    <a href="/ahp-sub/tambah/<?= $batu['id_batu'] ?>" class="btn btn-sm btn-info">
                        <i class="fa fa-balance-scale"></i> tambah Bobot
                    </a>
                    <a href="<?= base_url('ahp/sub/' . $batu['id_batu'] . '/' . $k['id_kriteria']) ?>"
                            ...
                            <?php foreach ($sub_kriteria[$k['id_kriteria']] as $s): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/batu/<?= $batu['id_batu'] ?>/sub-kriteria/edit/<?= $s['id_sub'] ?>"
                                            class="btn btn-warning btn-sm">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        <a href="/batu/<?= $batu['id_batu'] ?>/sub-kriteria/hapus/<?= $s['id_sub'] ?>"
